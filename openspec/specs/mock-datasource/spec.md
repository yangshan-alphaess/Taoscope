...
DataSource interface contract and in-memory mock implementation. Defines the seam between UI components and any concrete data backend (mock today, Tauri/HTTP in Phase 2).
